// layouts/public/components/libro-recomponentclamaciones.tsx
"use client";
...
export function LibroReclamaciones({ isOpen, onClose }: LibroReclamacionesProps) {
  ...
  const { register, handleSubmit, reset, control, formState: { errors } } = useForm<LibroReclamacionesFormData>({
  ...
  // Usar useWatch en lugar de watch para evitar el warning
