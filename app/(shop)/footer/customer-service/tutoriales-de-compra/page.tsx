    ...
    <div className="relative">
      ...
      <div className={`flex flex-col md:flex-row items-center gap-6 ${isEven ? 'md:flex-row-reverse' : ''}`}>
        ...
        <div className={`flex-1 ${isEven ? 'md:text-left' : 'md:text-right'}`}>
          <div className={`bg-white p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100`}>
        ...
        <div className="relative z-10 flex flex-col items-center">
          <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-700 flex flex-col items-center justify-center text-white shadow-lg shadow-blue-500/30">
            <span className="text-2xl font-bold">{step.step}</span>
          </div>
          <div className="mt-2 p-2 bg-blue-100 text-blue-600">
